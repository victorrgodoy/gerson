...
const doutorEstranho = {
    ...
    armaPrincipal: "Magia e olho de Agamotto",
    armaSecundaria: "",
    velocidade: 70,
    forca: 65,
    resistencia: 90,
...
personagens.push(gaviãoArqueiro);
personagens.push(panteraNegra);
personagens.push(homemAranha);
personagens.push(doutorEstranho);
